...
## Level 1: Basic operations
  ...
  ``` {r}
    ...
    # And more simple stuff like only keep some variables of the database
  ...
  # And we can merge this dataframe with our municipal spatial object 
  
  # But first some modification, we are going to pass to the municipal level 
  
  # And create relevant indicators as the density of population by district 
